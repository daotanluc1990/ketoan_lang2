  ...
  return (
    <div className="space-y-4">
      ...
      <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard label="AI Agent" value={hasAiProviderEnv() ? (aiProvider === 'gemini' ? 'Gemini' : 'OpenAI') : 'Thiếu env'} status={hasAiProviderEnv() ? 'good' : 'warning'} trend={hasGeminiEnv() ? 'Gemini 2.5 Flash' : hasOpenAiEnv() ? 'OpenAI dự phòng' : 'Cần AI key'} />

...
export default function CongNoPage() {
  return (
    <V7ModulePage
      ...
      primaryHeaders={['Ngày', 'Chi nhánh', 'Nhà cung cấp/Đối tượng', 'Nhóm công nợ', 'Phải trả', 'Đã trả', 'Còn phải trả', 'Nợ cuối T24', 'Chênh lệch', '% thay đổi', 'Đến hạn', 'Quá hạn', 'Trạng thái', 'Ghi chú']}
      notes={[

...
export const GOOGLE_SHEETS_SCHEMA: SheetSchema[] = [
  ...
  { sheetName: 'DL_XUAT_BTT_CHO_CUA_HANG', description: 'BTT xuất cho cửa hàng.', columns: [...BASE_IMPORT_COLUMNS, 'Ngày', 'Năm', 'Tháng', 'Tuần', 'Mã tuần', 'Chi nhánh', 'Cửa hàng', 'Mã phiếu', 'Kho xuất', 'Mã hàng', 'Tên hàng', 'Số lượng xuất', 'Số lượng', 'SL xuất', 'Giá trị xuất', 'Đơn vị tính', 'Trạng thái', ...AUDIT_COLUMNS] },

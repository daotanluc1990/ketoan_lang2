...
const TARGETS: V7Target[] = [
  { sheetName: SHEET_NAMES.DL_DOANH_THU_CUA_HANG, loaiDuLieu: 'Doanh thu cửa hàng', keywords: ['doanh thu cua hang', 'doanhthu cuahang', 'template doanh thu', 'doanh thu'], requiredHeaders: ['Ngày', 'Chi nhánh|Tên CH|Cửa hàng', 'Kênh bán|Ca bán|Mã đơn', 'Thành tiền|Tổng doanh thu|Tiền mặt'], identityHeaders: ['Ngày', 'Chi nhánh', 'Kênh bán', 'Mã đơn', 'Mã món'], dateHeaders: DATE_HEADERS, branchHeaders: ['Chi nhánh', 'Cửa hàng', 'Tên CH'], numericHeaders: ['Số lượng', 'Số lượng bán', 'Đơn giá', 'Thành tiền', 'Tổng doanh thu', 'Tiền mặt', 'MoMo/chuyển khoản'] },
  cashbookTarget(),
  { sheetName: SHEET_NAMES.DL_CONG_NO, loaiDuLieu: 'Công nợ', keywords: ['cong no', 'congno', 'phai tra', 'con phai tra', 'bigbyliabilities', 'bao cao cong no'], requiredHeaders: ['Nhà cung cấp|Đối tượng|Tên đối tượng|NCC|Khách hàng|Tên nhà cung cấp|Mã nhà cung cấp', 'Còn phải trả|Phải trả|Công nợ|Dư nợ|Số tiền|Nợ cuối kỳ|Nợ đầu kỳ'], identityHeaders: ['Nhà cung cấp', 'Đối tượng', 'Tên đối tượng', 'NCC', 'Ngày', 'Mã nhà cung cấp', 'Tên nhà cung cấp'], dateHeaders: DATE_HEADERS, branchHeaders: ['Chi nhánh', 'Cửa hàng'], numericHeaders: ['Phải trả', 'Đã trả', 'Còn phải trả', 'Công nợ', 'Dư nợ', 'Quá hạn', 'Nợ đầu kỳ', 'Ghi nợ', 'Ghi có', 'Nợ cuối kỳ'], looseSchema: true },
  ...
  { sheetName: SHEET_NAMES.DM_CONG_THUC_CHE_BIEN, loaiDuLieu: 'Công thức chế biến', keywords: ['cong thuc che bien', 'dinh muc mon', 'recipe', 'template dinh muc mon ban', 'template dinhmuc', 'dinhmucmonban'], requiredHeaders: ['Mã món', 'Mã NVL', 'Định mức'], identityHeaders: ['Mã món', 'Mã NVL', 'Tên món', 'Tên NVL'], branchHeaders: ['Chi nhánh', 'Cửa hàng'], numericHeaders: ['Định mức', 'Tỷ lệ hao hụt', 'Số lượng', 'Hao hụt hợp lệ'] },
  { sheetName: SHEET_NAMES.DM_HAO_HUT_HOP_LE, loaiDuLieu: 'Hao hụt hợp lệ', keywords: ['hao hut hop le', 'dinh muc hao hut', 'template hao hut hop le', 'haohuthople'], requiredHeaders: ['Mã NVL', 'Hao hụt hợp lệ|Tỷ lệ hao hụt hợp lệ'], identityHeaders: ['Mã NVL', 'Tên NVL', 'Nhóm NVL', 'Nhóm'], numericHeaders: ['Hao hụt hợp lệ', 'Tỷ lệ hao hụt hợp lệ', 'Tỷ lệ hao hụt'] },
  ...
  { sheetName: SHEET_NAMES.DL_XNT_CUA_HANG, loaiDuLieu: 'XNT cửa hàng', keywords: ['xnt cua hang', 'xuat nhap ton cua hang', 'kho cua hang', 'ton kho cua hang', 'dl xnt cua hang'], requiredHeaders: ['Mã hàng|Mã NVL|Tên hàng', 'Tồn cuối kỳ|Tồn kho|Tồn thực tế|Tồn|Số lượng|SL'], identityHeaders: ['Ngày', 'Chi nhánh', 'Kho', 'Mã hàng', 'Tên hàng'], dateHeaders: DATE_HEADERS, branchHeaders: ['Chi nhánh', 'Cửa hàng'], khoHeaders: ['Kho', 'Kho cửa hàng'], numericHeaders: ['Tồn đầu', 'Nhập', 'Nhập từ BTT', 'Nhập NCC', 'Xuất', 'Số lượng bán', 'Hủy', 'Tồn lý thuyết', 'Tồn thực tế', 'Lệch', 'Giá trị lệch'], looseSchema: true },
  { sheetName: SHEET_NAMES.DL_XNT_BEP_TRUNG_TAM, loaiDuLieu: 'XNT Bếp Trung Tâm', keywords: ['xnt bep trung tam', 'xnt btt', 'kho btt', 'ton kho bep trung tam', 'ton kho btt', 'ton kho bep', 'producinoutstock', 'bao cao xuat nhap ton'], requiredHeaders: ['Tên hàng|Tên NVL|Tên nguyên liệu|Nguyên liệu|Mặt hàng|Sản phẩm|Tên sản phẩm|Tên|Mã hàng|Mã NVL', 'Tồn cuối kỳ|Tồn kho|Tồn thực tế|Tồn|Số lượng|SL'], identityHeaders: ['Ngày', 'Kho', 'Mã hàng', 'Tên hàng'], dateHeaders: DATE_HEADERS, branchHeaders: ['Chi nhánh'], khoHeaders: ['Kho', 'Kho BTT'], numericHeaders: ['Tồn đầu kỳ', 'Tồn đầu', 'SL Nhập', 'Nhập NCC', 'SL Xuất', 'Xuất cửa hàng', 'Tồn cuối kỳ', 'Tồn kho', 'Tồn thực tế', 'Tồn', 'Số lượng', 'SL', 'Giá trị đầu kỳ', 'Giá trị nhập', 'Giá trị xuất', 'Giá trị cuối kỳ'], looseSchema: true },
  ...
  // KiotViet: DanhSachChiTietNhapHang → phiếu nhập hàng từ NCC. Ghi vào XNT BTT/cửa hàng.
  // Chi nhánh "trung tâm" = BTT, "chi nhánh" khác = cửa hàng. Loại nhận diện qua filename KiotViet.
  { sheetName: SHEET_NAMES.DL_XNT_BEP_TRUNG_TAM, loaiDuLieu: 'Nhập hàng từ NCC (KiotViet)', keywords: ['danhsachchitietnhaphang', 'danh sach chi tiet nhap hang', 'nhaphang', 'nhap hang', 'purchaseorder'], requiredHeaders: ['Mã nhập hàng|Mã nhà cung cấp|Nhà cung cấp', 'Mã hàng', 'Tên hàng|Tên NVL', 'Số lượng|Thành tiền|Đơn giá'], identityHeaders: ['Mã nhập hàng', 'Mã nhà cung cấp', 'Nhà cung cấp', 'Mã hàng', 'Tên hàng'], dateHeaders: ['Thời gian', 'Ngày cập nhật', ...DATE_HEADERS], branchHeaders: ['Chi nhánh'], khoHeaders: ['Kho'], numericHeaders: ['Tổng tiền hàng', 'Đơn giá', 'Giá nhập', 'Thành tiền', 'Số lượng', 'Tổng số lượng', 'VAT nhập hàng'], looseSchema: true },
  // KiotViet: DanhSachXuatHuy → phiếu xuất hủy. BTT xuất hủy cho cửa hàng.
  { sheetName: SHEET_NAMES.DL_XUAT_BTT_CHO_CUA_HANG, loaiDuLieu: 'Xuất hủy (KiotViet)', keywords: ['danhsachxuathuy', 'danh sach xuat huy', 'xuathuy', 'xuat huy'], requiredHeaders: ['Mã xuất hủy', 'Chi nhánh|Cửa hàng', 'Tổng giá trị|Số lượng'], identityHeaders: ['Mã xuất hủy', 'Chi nhánh', 'Ghi chú'], dateHeaders: ['Thời gian', ...DATE_HEADERS], branchHeaders: ['Chi nhánh', 'Cửa hàng'], khoHeaders: ['Kho xuất', 'Kho BTT'], numericHeaders: ['Tổng giá trị', 'Số lượng'], looseSchema: true },
  // Lương/Nhân sự: TEMPLATE_Luong_NhanSu hoặc file chấm công/bảng lương
  { sheetName: SHEET_NAMES.DATA_NHAN_SU_LUONG, loaiDuLieu: 'Lương & Nhân sự', keywords: ['luong nhansu', 'luong nhan su', 'bang luong', 'cham cong', 'nhan su', 'template luong'], requiredHeaders: ['Nhân viên|Họ tên|Tên nhân viên', 'Kỳ lương|Tháng|Kỳ', 'Số công|Công|Giờ làm|Thực nhận|Lương'], identityHeaders: ['Nhân viên', 'Họ tên', 'Kỳ lương', 'Cửa hàng', 'Vai trò'], dateHeaders: ['Kỳ lương', 'Tháng', 'Kỳ'], branchHeaders: ['Cửa hàng', 'Chi nhánh'], numericHeaders: ['Số công', 'Giờ làm', 'Đi trễ', 'Nghỉ', 'Ca gãy', 'Tạm ứng', 'Thưởng', 'Phạt', 'Phụ cấp', 'Lương tạm tính', 'Khấu trừ', 'Thực nhận', 'Lương'], looseSchema: true }
];
...
function isSpecificBttInventoryFilename(filename: string) { return filename.includes('ton kho bep trung tam') || filename.includes('ton kho btt') || filename.includes('xnt bep trung tam') || filename.includes('xnt btt') || filename.includes('producinoutstock') || filename.includes('bao cao xuat nhap ton'); }
function isSpecificStoreInventoryFilename(filename: string) { return filename.includes('dl xnt cua hang') || filename.includes('xnt cua hang') || filename.includes('ton kho cua hang') || filename.includes('kho cua hang'); }
function forcedFilenameTarget(filename: string) { if (filename.includes('template doanht hu') || filename.includes('template doanh thu') || filename.includes('doanhthu cuahang') || filename.includes('doanh thu cua hang')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DL_DOANH_THU_CUA_HANG) ?? null; if (filename.includes('template dinhmuc') || filename.includes('template dinh muc') || filename.includes('dinhmucmonban') || filename.includes('dinh muc mon ban')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DM_CONG_THUC_CHE_BIEN) ?? null; if (filename.includes('template haohut') || filename.includes('template hao hut')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DM_HAO_HUT_HOP_LE) ?? null; if (filename.includes('template luong') || filename.includes('template nhansu') || filename.includes('template nhan su') || filename.includes('luong nhansu')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DATA_NHAN_SU_LUONG) ?? null; if (filename.includes('soquy') || filename.includes('so quy')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DL_SO_QUY) ?? cashbookTarget(); if (filename.includes('congno') || filename.includes('cong no')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DL_CONG_NO) ?? null; if (filename.includes('xuat huy') || filename.includes('xuathuy') || filename.includes('productbydamageitem')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DL_XUAT_BTT_CHO_CUA_HANG) ?? null; if (filename.includes('producinoutstock') || filename.includes('bao cao xuat nhap ton')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DL_XNT_BEP_TRUNG_TAM) ?? null; if (filename.includes('danhsachchitietnhaphang') || filename.includes('danh sach chi tiet nhap hang')) return TARGETS.find((target) => target.sheetName === SHEET_NAMES.DL_XNT_BEP_TRUNG_TAM) ?? null; return null; }
...
function findTarget(input: ExcelFileInput, sheetNames: string[], firstSheetName: string, matrix: unknown[][]): V7Target | null {
  ...
  const filenameByKeyword = TARGETS.find((target) => target.keywords.some((keyword) => filename.includes(normalize(keyword))) && (headerScore(matrix, target) >= 1 || (target.sheetName === SHEET_NAMES.DL_XNT_BEP_TRUNG_TAM && isSpecificBttInventoryFilename(filename)) || (target.sheetName === SHEET_NAMES.DL_XNT_CUA_HANG && isSpecificStoreInventoryFilename(filename))));
...
function isStoreInventorySummaryRow(row: Record<string, unknown>) { const code = normalize(getValue(row, ['Mã hàng', 'Mã NVL'])); return code.includes('sl mat hang') || code.includes('tong cong') || code.includes('tong'); }
...
function canonicalizeStoreInventoryRow(row: Record<string, unknown>) { const code = getValue(row, ['Mã hàng', 'Mã NVL']); const name = getValue(row, BTT_ITEM_HEADERS); const finalQty = getValue(row, BTT_STOCK_HEADERS); const importQty = getValue(row, ['Nhập từ BTT', 'SL Nhập', 'Nhập NCC', 'Nhập']); const saleQty = getValue(row, ['Số lượng bán', 'SL Xuất', 'Xuất bán', 'Xuất']); return { ...row, 'Mã hàng': code, 'Tên hàng': name || code, 'Kho': getValue(row, ['Kho', 'Kho cửa hàng']) || 'Kho cửa hàng', 'Tồn đầu': getValue(row, ['Tồn đầu kỳ', 'Tồn đầu']), 'Nhập từ BTT': importQty, 'Nhập': importQty, 'Số lượng bán': saleQty, 'Xuất': saleQty, 'Hủy': getValue(row, ['Hủy', 'SL Hủy', 'Tổng SL hủy']) || 0, 'Tồn lý thuyết': finalQty, 'Tồn thực tế': finalQty, 'Lệch': 0, 'Giá trị lệch': 0, 'Trạng thái': 'Đạt' }; }
...
export function parseV7ExcelFile(input: ExcelFileInput): ParsedExcelImport | null {
  ...
  const isStoreInventory = target.sheetName === SHEET_NAMES.DL_XNT_CUA_HANG;
  ...
  const rows = sheetToRows(picked.sheet, headerRowIndex)
    .filter((row) => !(isStoreInventory && isStoreInventorySummaryRow(row)))
